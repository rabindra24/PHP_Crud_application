  ...
  <div class="formbox my-1">
    <form action="" method="POST">
      <div class="form-group my-2">
        ...
        <input type="text" class="form-control" placeholder="ID" id="sid" name="sid">
      </div>
  ...
  <div class="container mycon">
    <div class="formbox my-3">
      <form action="del.php" method="POST">
        ...
        <button type="submit" class="btn button red" onclick="return confirm('Are You Sure ?')">Delete</button>
        <?php
      }
      ?>
      </form>
